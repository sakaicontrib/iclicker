...
<%
    String toolBaseCSS = org.sakaiproject.iclicker.tool.utils.CSSUtils.getCssToolBase();
    String toolCSS = org.sakaiproject.iclicker.tool.utils.CSSUtils.getCssToolSkin((String)null);
%>
